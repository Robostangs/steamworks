...
public class SideGearShototSpecialEdition extends AutoMode {
private boolean isRed;
	
	public SideGearShototSpecialEdition(boolean isRed) {
		super("Side gear and then shoot");
		this.isRed = isRed;
	...
	protected void run() {
		...
		else turnToAngleInTime(1.5, 303, false);
